...
public class TTSUtility {
    ...
    private static SynthesizerListener mTtsListener = new SynthesizerListener() {
        ...
        public void onSpeakProgress(int percent, int beginPos, int endPos) {
            // TODO 说话的进度public final static String[] COLOUD_VOICERS_VALUE = {"xiaoyan", "xiaoyu", "catherine", "henry", "vimary", "vixy", "xiaoqi", "vixf", "xiaomei","xiaolin", "xiaorong", "xiaoqian", "xiaokun", "xiaoqiang", "vixying", "xiaoxin", "nannan", "vils",};
    ...
    private void setParam() {
        ...
        // 设置发音人
        mTts.setParameter(SpeechConstant.VOICE_NAME, COLOUD_VOICERS_VALUE[13]);

        //String[] COLOUD_VOICERS_VALUE = {"xiaoyan", "xiaoyu", "catherine", "henry", "vimary",
        // "vixy", "xiaoqi", "vixf", "xiaomei","xiaolin", "xiaorong", "xiaoqian", "xiaokun",
        // "xiaoqiang", "vixying", "xiaoxin", "nannan", "vils",};

        // 设置语速
        mTts.setParameter(SpeechConstant.SPEED, "90");  //50
        // 设置音调
        mTts.setParameter(SpeechConstant.PITCH, "50");  //50
        // 设置音量
